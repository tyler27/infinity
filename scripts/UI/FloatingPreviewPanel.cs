...
/// <summary>
/// A draggable, resizable floating panel that stays within the application window.
/// Drag the title bar to move. Drag edges/corners to resize.
/// </summary>
public partial class FloatingPreviewPanel : Control
{
    ...
    private static readonly Vector2 MinPanelSize = new Vector2(320, 240);
    ...
    {
        // This control needs to capture all mouse input over it
        MouseFilter = MouseFilterEnum.Stop;
        ClipContents = true;

        // Content sits below title bar
    ...
    public override void _Draw()
    {
        ...
        int fontSize = 13;
        DrawString(font, new Vector2(12, 20), "Laser Preview", HorizontalAlignment.Left,
